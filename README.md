...
![](images/eqn_wst_linear_projection.svg)
...
**Implication To Trust As "Prisoner's Dilemma".** By looking beyond the opponent action at face value (collaborate, defect) and recognizing a well-defined third option (reciprocate), a strategy is actually able to conceptualize that their collaboration feeds back to their own gain at a later time, as well as quantitatively estimate the expected amount. Repeated interactions aren't just vibes. They're mathematical promises of "we will likely meet again" by which karma sometimes becomes a source of profit through the opponent's wiring. If you know how likely the opponent is to reciprocate, you know exactly what to do. The dilemma dies at the hand of "tomorrow".